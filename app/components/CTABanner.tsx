...
export default function CTABanner() {
  ...
  return (
    <section ref={ref as React.RefObject<HTMLElement>} className="w-full px-4 py-10 md:py-16">
      <div
        className="reveal max-w-5xl mx-auto rounded-3xl overflow-hidden px-8 py-20 md:py-24 flex flex-col items-center text-center"
        style={{ background: "linear-gradient(135deg, #cce9f8 0%, #e8f5fd 40%, #b8ddf5 100%)" }}
      >
        ...
        <div className="reveal delay-200 flex flex-col sm:flex-row items-center gap-4">
          <Link href="/start" className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#009FE3] text-white font-semibold rounded-xl shadow-lg shadow-[#009FE3]/25 hover:bg-[#0089c4] hover:-translate-y-0.5 transition-all duration-300 text-base">
