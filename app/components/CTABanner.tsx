    ...
    <section ref={ref as React.RefObject<HTMLElement>} className="w-full px-4 py-10 md:py-16">
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 rounded-3xl">
          ...
          {/* Flowing Light Leaks */}
          <div className="absolute top-[-10%] left-[-10%] w-[600px] h-[600px] bg-gradient-to-br from-[#009FE3]/15 to-transparent rounded-full blur-[100px] animate-[pulse_8s_ease-in-out_infinite]" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] bg-gradient-to-tl from-[#009FE3]/10 to-transparent rounded-full blur-[100px] animate-[pulse_10s_ease-in-out_infinite]" />
          ...
          {/* Watermark */}
          <div className="absolute top-[10%] right-[2%] text-[8vw] font-black text-[#0f172a] leading-none opacity-[0.02] select-none tracking-tighter">
            ELEVATE
          </div>
        </div>
